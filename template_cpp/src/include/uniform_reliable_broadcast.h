...
struct PAM {
  ...
  uint sum; // how many processes beb delivered this packet, optimization to
            // avoid traversing the array
  bool ack[MAX_PROCESSES]; // TODO: dynamic, which process acked the packet
  char content[MAX_CHARS]; // TODO: dynamic, content of the packet
  size_t n;                // Number of bytes of content
};
